...
<Tip>
Functions can query data synced from external sources via [data connectors](/building/data-connectors). Connect a source like HubSpot or Google Sheets, sync the data into a data model, and your agent's functions can access it just like any other app data.
</Tip>
