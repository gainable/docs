...
## Custom AI agents in your apps

The agents described above (Planner, Build, Validation, Conversation) are **build agents** — they work behind the scenes to create your app. Gainable also lets you create **custom AI agents** that live inside your finished app as interactive assistants for your users.

Custom agents can chat with users, query your app's data, reference uploaded documents, and provide guidance through an embedded copilot interface.

<Card title="Learn about custom AI agents" icon="robot" href="/agents/overview" horizontal>
  Create AI assistants with data access, knowledge bases, and an embedded chat interface
</Card>
