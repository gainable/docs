...
The agents described above (Planner, Build, Validation, Conversation) are **build agents** that work behind the scenes to create your app. Gainable also lets you create **custom AI agents** that live inside your finished app as interactive assistants for your users.
